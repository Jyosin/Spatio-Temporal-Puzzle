...
from models.model_component import PatchEmbed, TransformerContainer, get_sine_cosine_pos_emb
...
class ViViT(nn.Module):
	...
	def prepare_tokens(self, x,use_pos_embed=True):
		#Tokenize
		b = x.shape[0]
	...
	def forward(self, x,use_pos_embed=True):
		x, cls_tokens, b = self.prepare_tokens(x,use_pos_embed=use_pos_embed)
